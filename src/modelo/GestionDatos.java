...
public class GestionDatos {
	...
	public RespuestaTresEnRaya comprobarTresEnRaya() {
		RespuestaTresEnRaya comprobar = new RespuestaTresEnRaya();
		if (juego.isComprobacion()) {
			if (tablero.comprobarTresEnRaya()) {
				comprobar = new RespuestaTresEnRaya(true, "fin de juego", this.juego.getTurnoActual());
			} else {

				comprobar = new RespuestaTresEnRaya(false, "", this.juego.getTurnoActual());
			}
		}
		return comprobar;
